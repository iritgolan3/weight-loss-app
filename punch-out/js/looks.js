  ...
  var LOOKS = {
    ...
    glassjoe: {
      ...
      head: { hairKey: 'glassjoe', hair: C.orange, hairL: C.tan, hairD: C.orangeD,
              skin: C.skin, skinD: C.skinD, skinL: C.skinL,
              hw: 11, len: 27, jaw: 'pointed', brow: 'none', eyes: 'droopy',
              nose: { len: 7, hook: true }, mouth: 'frown', mouthW: 3, eyeDX: 6 }
    },
    ...
    vonkaiser: {
      ...
      head: { hairKey: 'vonkaiser', facialKey: 'vonkaiser',
              hair: C.brown, hairL: C.brownL, hairD: C.brownD,
              skin: C.skin, skinD: C.skinD, skinL: C.skinL,
              hw: 11, len: 25, jaw: 'square', brow: 'angry', eyes: 'angry',
              nose: { len: 5, wide: true }, mouth: 'flat', mouthW: 4, mouthGap: 6 }
    },
    ...
    pistonhonda: {
      ...
      head: { hairKey: 'pistonhonda', hair: C.black, hairL: C.grey3, hairD: C.black,
              skin: C.tanSkin, skinD: C.tanSkinD, skinL: C.gold,
              hw: 11, len: 24, jaw: 'square', brow: 'angry', eyes: 'angry',
              nose: { len: 4 }, mouth: 'flat', mouthW: 4,
    ...
    donflamenco: {
      ...
      head: { hairKey: 'donflamenco', hair: C.black, hairL: C.grey3, hairD: C.black,
              skin: C.skin, skinD: C.skinD, skinL: C.skinL,
              hw: 11, len: 27, jaw: 'pointed', brow: 'flat', eyes: 'normal',
              nose: { len: 6, hook: true }, mouth: 'grin', mouthW: 3 }
    },
    ...
    kinghippo: {
      ...
      build: build({ shW: 68, waistW: 58, belly: 21, hipY: 20, shY: 56, spread: 21,
                     ...
                     elbowOut: 13, gloveR: 11, guardY: 30 }),
      head: { hairKey: 'kinghippo', hair: C.orange, hairL: C.tan, hairD: C.orangeD,
              skin: C.orange, skinD: C.orangeD, skinL: C.tan,
              hw: 11, len: 21, jaw: 'jowly', brow: 'heavy', eyes: 'squint',
              nose: { len: 3, wide: true }, mouth: 'wide', mouthW: 6, mouthGap: 3,
              ears: false, eyeDX: 7, acc: { a: C.blueL, b: C.yellow } }
    },
    ...
    greattiger: {
      ...
      head: { hairKey: 'greattiger', facialKey: 'greattiger',
              hair: C.black, hairL: C.grey3, hairD: C.black,
              skin: C.darkSkinL, skinD: C.darkSkin, skinL: C.tanSkin,
              hw: 11, len: 24, jaw: 'round', brow: 'angry', eyes: 'angry',
              nose: { len: 5 }, mouth: 'flat', mouthW: 3, ears: false,
    ...
    baldbull: {
      ...
      head: { hairKey: 'baldbull', facialKey: 'baldbull',
              hair: C.brownD, hairL: C.brown, hairD: C.black,
              skin: C.tanSkin, skinD: C.tanSkinD, skinL: C.gold,
              hw: 13, len: 25, jaw: 'square', brow: 'heavy', eyes: 'angry',
              nose: { len: 5, wide: true }, mouth: 'flat', mouthW: 4, mouthGap: 5 }
    },
    ...
    sodapopinski: {
      ...
      head: { hairKey: 'sodapopinski', facialKey: 'sodapopinski',
              hair: C.brownD, hairL: C.brown, hairD: C.black,
              skin: C.skin, skinD: C.skinD, skinL: C.skinL,
              hw: 13, len: 25, jaw: 'square', brow: 'heavy', eyes: 'normal',
              nose: { len: 5, wide: true }, mouth: 'grin', mouthW: 4 }
    },
    ...
    mrsandman: {
      ...
      head: { hairKey: 'mrsandman', facialKey: 'mrsandman',
              hair: C.black, hairL: C.grey3, hairD: C.black,
              skin: C.darkSkin, skinD: C.darkSkinD, skinL: C.darkSkinL,
              hw: 13, len: 25, jaw: 'square', brow: 'angry', eyes: 'angry',
              nose: { len: 4, wide: true }, mouth: 'teeth', mouthW: 5 }
    },
    ...
    machoman: {
      ...
      head: { hairKey: 'machoman', facialKey: 'machoman',
              hair: C.brownD, hairL: C.brown, hairD: C.black,
              skin: C.tanSkin, skinD: C.tanSkinD, skinL: C.gold,
              hw: 11, len: 25, jaw: 'square', brow: 'angry', eyes: 'normal',
              nose: { len: 4 }, mouth: 'grin', mouthW: 4 }
    },
    ...
    tyson: {
      ...
      head: { hairKey: 'tyson', hair: C.black, hairL: C.grey3, hairD: C.black,
              skin: C.darkSkin, skinD: C.darkSkinD, skinL: C.darkSkinL,
              hw: 13, len: 24, jaw: 'square', brow: 'heavy', eyes: 'angry',
              nose: { len: 4, wide: true }, mouth: 'teeth', mouthW: 5, goldTooth: true }
    },
